...
def get_news_from_api(start_time, end_time, data_file):
    ...
    print("all_ids: {}".format(ids_count1))
    print("political_ids: {}".format(ids_count))
...
def test1():
    # start_time = time_utils.n_days_ago_milli_time(1)
    # end_time = time_utils.n_days_ago_milli_time(0)
    start_time = 1553043600000
    end_time = 1553130000000
    data_file = './for_fx7.txt'
    get_news_from_api(start_time, end_time, data_file)
